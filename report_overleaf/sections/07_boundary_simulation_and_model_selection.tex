...
The day-count column in the following tables refers to valid historical backtest days that survive the boundary-simulation filters, not to the total number of calendar or trading days in the competition.
...
\begin{tabular}{lrrrr}
\toprule
Cutoff & Method & Valid Backtest Days & Mean MAE & Median MAE \\
\midrule
...
\begin{tabular}{lrrr}
\toprule
Method & Valid Backtest Days & Mean MAE & Median MAE \\
\midrule
